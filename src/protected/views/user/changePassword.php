<?php $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array('layout' => TbHtml::FORM_LAYOUT_INLINE, 'htmlOptions'=>array('autocomplete' => 'off')));?>
   ...
   <div class="well">
      ...
      <div class="row">
         ...
         <?php echo $form->passwordFieldControlGroup($model, 'change_password', array('class'=>'span2','groupOptions'=>array('class'=>'span2'))); ?>
         <?php echo $form->passwordFieldControlGroup($model, 'change_repassword', array('class'=>'span2','groupOptions'=>array('class'=>'span2'))); ?>
      </div>
