<?php
   ...
   echo $form->textFieldControlGroup($model, 'telefonoFijo', array('prepend' => '02972', 'span'=>2));
   echo $form->textFieldControlGroup($model, 'telefonoCelularPre');
   echo $form->textFieldControlGroup($model, 'telefonoCelular', array('prepend' => '15', 'span'=>2));
